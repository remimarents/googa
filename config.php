...
const GOOGA_INTRO_PRODUCT_ID = 'prod_UzmBvmhy3Xzpry';
const GOOGA_INTRO_PRICE_ID = 'price_1TzmcrBgfqMKZQay4mVh7rVJ';
...
const GOOGA_AMBASSADOR_AGREEMENT_VERSION = 'GOOGA-AMB-NO-1.1';
