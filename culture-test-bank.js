window.GOOGA_CULTURE_TEST = {
  ...
  dimensions: {
    norway: { icon:'🇳🇴', so:'Aqoonta nolosha Norway', no:'Norsk hverdagsradar', copySo:'Caadooyinka, afka iyo nolol maalmeedka', copyNo:'Vaner, språk og norsk hverdagsliv' },
    ...
    bridge: { icon:'🌉', so:'Isku xidhka labada dhaqan', no:'Brobyggerblikk', copySo:'Labada dhinac isku xidh oo sharax', copyNo:'Koble, forklare og bruke begge sider' }
  },
  categories: {
  ...
  questions: [
    { id:'BPG-NO-01', category:'norway', so:'Sabtida waxaa jira dugnad xaafadda. Maxaad samaynaysaa?', no:'Borettslaget har dugnad på lørdag. Hva gjør du?', options:[
      {id:'a',icon:'🧤',so:'Waxaan ku imaadaa waqtiga, anigoo wata gacmo-gashi iyo qorshe.',no:'Møter presis med arbeidshansker og en plan.',score:{norway:3,heritage:0,bridge:1}},
      {id:'b',icon:'🥟',so:'Waxaan keenaa sambuus; qof kale ha qaato qalabka beerta.',no:'Tar med sambuus – noen andre får ta riva.',score:{norway:2,heritage:2,bridge:3}},
    ...
    { id:'BPG-NO-02', category:'norway', so:'Berri waxaad u baahan tahay qado shaqo. Maxaa ku jira boorsada?', no:'Du trenger lunsj på jobb i morgen. Hva havner i veska?', options:[
      {id:'a',icon:'🥪',so:'Sandwiij habeenkii la sii diyaariyey.',no:'Matpakke smurt kvelden før.',score:{norway:3,heritage:0,bridge:1}},
      ...
      {id:'c',icon:'🛒',so:'Waxaan wax ka iibsadaa kantinka marka aan gaaro.',no:'Kjøper noe i kantina når jeg kommer.',score:{norway:2,heritage:0,bridge:0}},
    ...
    { id:'BPG-NO-03', category:'norway', so:'Qof aadan aqoon ayaa wiishka ku yiraahda: “Cimilo xun maanta.” Maxaad tiraahdaa?', no:'En fremmed i heisen sier: «For et vær i dag.» Hva svarer du?', options:[
    ...
    { id:'BPG-NO-04', category:'norway', so:'Saaxiib ayaa Vipps kuugu soo dalbaday 47 karoon. Sideed uga jawaabtaa?', no:'En venn sender et Vipps-krav på 47 kroner. Hva gjør du?', options:[
      ...
      {id:'b',icon:'☕',so:'Waxaan iraahdaa: “Marka xiga shaaha anigaa bixinaya.”',no:'Sier: «Jeg tar teen neste gang.»',score:{norway:1,heritage:2,bridge:2}},
    ...
    { id:'BPG-NO-05', category:'norway', so:'17-ka May sidee ku bilaabataa?', no:'Hvordan starter 17. mai hos deg?', options:[
      {id:'a',icon:'🇳🇴',so:'Calan, jadwal iyo ogaanshaha meesha ay carruurtu safka marayaan.',no:'Flagg, tidsskjema og full kontroll på barnetoget.',score:{norway:3,heritage:0,bridge:1}},
    ...
    { id:'BPG-NO-06', category:'norway', so:'Waxaa lagugu martiqaaday hytte aan lahayn biyo tuubbo ah. Maxaad diyaarsataa?', no:'Du er invitert på hytte uten innlagt vann. Hva forbereder du?', options:[
      {id:'a',icon:'🧦',so:'Dhar dhogor ah, sharaabaad dheeraad ah iyo Kvikk Lunsj.',no:'Ullundertøy, ekstra sokker og Kvikk Lunsj.',score:{norway:3,heritage:0,bridge:1}},
    ...
    { id:'BPG-NO-08', category:'norway', so:'Qof ayaa fiidkii kuu soo bandhiga Grandiosa. Maxaad samaynaysaa?', no:'Noen serverer Grandiosa en sen kveld. Hva gjør du?', options:[
      {id:'a',icon:'🍕',so:'Waan cunaa — waa cuntada degdegga ah ee Norway.',no:'Spiser – det er jo norsk beredskapsmat.',score:{norway:3,heritage:0,bridge:1}},
    ...
    { id:'BPG-HI-01', category:'heritage', so:'Qof weyn ayaa isticmaala maahmaah Soomaaliyeed oo aadan hubin. Maxaad samaynaysaa?', no:'En eldre bruker et somalisk ordtak du ikke er sikker på. Hva gjør du?', options:[
    ...
    { id:'BPG-HI-03', category:'heritage', so:'Kooxda qoyska waxaa ku jira farriin cod ah oo toddoba daqiiqo ah. Maxaad samaynaysaa?', no:'Familiechatten får en talemelding på sju minutter. Hva gjør du?', options:[
      ...
      {id:'d',icon:'⏩',so:'Waxaan ku dhegeystaa xawaare laba jibbaaran.',no:'Setter avspillingen på dobbel hastighet.',score:{norway:2,heritage:1,bridge:1}}
    ]},
    { id:'BPG-HI-04', category:'heritage', so:'Aroos Soomaali ah ayaa muusiggu bilaabmaa. Xaggee joogtaa?', no:'Musikken starter i et somalisk bryllup. Hvor er du?', options:[
      ...
      {id:'d',icon:'🍽️',so:'Waxaan ag joogaa miiska cuntada — si xeelad leh.',no:'Passer strategisk på matbordet.',score:{norway:0,heritage:1,bridge:0}}
    ]},
    { id:'BPG-HI-05', category:'heritage', so:'Qof ayaa ku weydiiya sida bariis Soomaali loo sameeyo. Maxaad tiraahdaa?', no:'Noen spør hvordan man lager somalisk bariis. Hva svarer du?', options:[
      {id:'a',icon:'🤌',so:'Gacantaada iyo urta ayaa kuu sheegaya qiyaasta.',no:'Man må kjenne mengden og lukten – oppskrift er sekundært.',score:{norway:0,heritage:3,bridge:1}},
      ...
      {id:'c',icon:'📞',so:'Waxaan wacaa qof weyn, dabadeedna habka iyo sheekadaba waan qoraa ama duubaa.',no:'Ringer en eldre og dokumenterer både maten og historien.',score:{norway:2,heritage:3,bridge:3}},
    ...
    { id:'BPG-HI-06', category:'heritage', so:'Ilmo ayaa ku weydiiya eray Soomaali ah oo adag. Maxaad samaynaysaa?', no:'Et barn spør om et vanskelig somalisk ord. Hva gjør du?', options:[
      ...
      {id:'d',icon:'😅',so:'Waxaan iraahdaa: “Markaad weynaato ayaad fahmi doontaa.”',no:'Sier: «Det forstår du når du blir eldre.»',score:{norway:0,heritage:1,bridge:0}}
    ]},
    { id:'BPG-HI-07', category:'heritage', so:'Qof ayaa qof kale ugu yeera “adeer” ama “eedo”. Sidee baad u fahmaysaa?', no:'Noen omtales som «adeer» eller «eedo». Hvordan tolker du det?', options:[
    ...
    { id:'BPG-HI-08', category:'heritage', so:'Laba qof ayaa isla sheeko Soomaali ah si kala duwan u sheegaya. Maxaad samaynaysaa?', no:'To personer forteller den samme somaliske historien forskjellig. Hva gjør du?', options:[
      ...
      {id:'c',icon:'🔎',so:'Waxaan raadiyaa ilo qoran, anigoo aan diidin sheekada afka laga weriyey.',no:'Leter etter skriftlige spor uten å avvise den muntlige historien.',score:{norway:3,heritage:2,bridge:3}},
    ...
    { id:'BPG-BR-02', category:'bridge', so:'War weyn oo Soomaaliya ku saabsan ayaa ku faafaya baraha bulshada. Maxaad samaynaysaa?', no:'En stor Somalia-nyhet sprer seg i sosiale medier. Hva gjør du?', options:[
      ...
      {id:'d',icon:'🧭',so:'Waxaan isbarbar dhigaa ilo, taariikhda arrinta iyo wararka dadka deegaanka.',no:'Sammenholder kilder, historikk og lokale erfaringer.',score:{norway:3,heritage:3,bridge:3}}
    ]},
    { id:'BPG-BR-03', category:'bridge', so:'Ilmo ayaa ku weydiiya: “Ma Soomaali baan ahay mise Noorwiiji?” Maxaad tiraahdaa?', no:'Et barn spør: «Er jeg somalisk eller norsk?» Hva svarer du?', options:[
      ...
      {id:'c',icon:'📘',so:'Waxaan sharxaa jinsiyadda iyo waxa waraaqaha rasmiga ahi sheegayaan.',no:'Forklarer statsborgerskap og hva papirene sier.',score:{norway:3,heritage:0,bridge:1}},
      {id:'d',icon:'🍚',so:'Waxaan iraahdaa: “Bariis iyo Grandis labadaba waad cuntaa.”',no:'Sier: «Du spiser jo både bariis og Grandis.»',score:{norway:1,heritage:2,bridge:2}}
    ]},
    { id:'BPG-BR-04', category:'bridge', so:'Qoyska ayaa isku khilaafsan caado ka duwan Norway iyo Soomaaliya. Maxaad samaynaysaa?', no:'Familien er uenig om en norm som er forskjellig i Norge og Somalia. Hva gjør du?', options:[
      {id:'a',icon:'🇳🇴',so:'Waxaan iraahdaa: “Norway ayaan joognaa.”',no:'Sier: «Vi er i Norge nå.»',score:{norway:3,heritage:0,bridge:0}},
      {id:'b',icon:'🇸🇴',so:'Waxaan iraahdaa: “Dhaqankeennu sidaas ma aha.”',no:'Sier: «Sånn gjør vi ikke i vår kultur.»',score:{norway:0,heritage:3,bridge:0}},
      {id:'c',icon:'↔️',so:'Waxaan sharxaa sababaha ka dambeeya labada aragti, dabadeedna xal ayaan raadinnaa.',no:'Forklarer logikken på begge sider og leter etter en løsning.',score:{norway:2,heritage:2,bridge:3}},
    ...
    { id:'BPG-BR-05', category:'bridge', so:'Waxaad qorshaynaysaa safar Soomaaliya. Maxaa ugu horreeya?', no:'Du planlegger en reise til Somalia. Hva gjør du først?', options:[
      ...
      {id:'c',icon:'🧭',so:'Waxaan isku daraa talo rasmi ah, aqoonta deegaanka iyo xiriirka qoyska.',no:'Kombinerer offisielle råd, lokalkunnskap og familiekontakter.',score:{norway:3,heritage:3,bridge:3}},
    ...
    { id:'BPG-BR-06', category:'bridge', so:'Waxaad rabtaa inaad kaydiso sheeko qoys. Sideed u samaynaysaa?', no:'Du vil bevare en familiehistorie. Hvordan gjør du det?', options:[
      ...
      {id:'b',icon:'⌨️',so:'Noorwiiji ayaan ku qoraa si carruurtu u akhriyaan.',no:'Skriver den på norsk så barna kan lese den.',score:{norway:3,heritage:1,bridge:2}},
    ...
    { id:'BPG-BR-07', category:'bridge', so:'Waxaad rabtaa inaad fahanto arrin siyaasadeed oo Soomaaliya ah. Maxaad samaynaysaa?', no:'Du vil forstå en politisk sak i Somalia. Hva gjør du?', options:[
      {id:'a',icon:'📱',so:'Waxaan dhegeystaa qof aan hore ugu kalsoonaa.',no:'Hører på en profil jeg allerede stoler på.',score:{norway:0,heritage:2,bridge:0}},
      ...
      {id:'d',icon:'🌍',so:'Waxaan isku daraa ilo maxalli ah, kuwo Soomaali ah, kuwo Norway ah iyo kuwo caalami ah.',no:'Kombinerer lokale, somaliske, norske og internasjonale kilder.',score:{norway:3,heritage:3,bridge:3}}
    ]},
    { id:'BPG-BR-08', category:'bridge', so:'Waxaad martigelinaysaa qoysas Soomaali iyo Noorwiiji ah. Sidee habeenku u ekaanayaa?', no:'Du inviterer både somaliske og norske familier. Hvordan blir kvelden?', options:[
      ...
      {id:'c',icon:'🎲',so:'Cunto, sheeko iyo ciyaar ayaa dadka isku dhexgalinaya.',no:'Mat, historier og en liten lek får folk til å blande seg.',score:{norway:3,heritage:3,bridge:3}},
  ...
  profiles: [
    { key:'fusion', icon:'🍚🍕', so:'Wasiirka Bariis på Grandis', no:'Ministeren for Bariis på Grandis', summarySo:'Saxankaagu baasaboor kuuma weydiiyo — labada dhinac si dabiici ah ayuu isugu daraa.', summaryNo:'Tallerkenen din spør ikke etter pass – begge sider møtes helt naturlig.' },
    ...
    { key:'balanced', icon:'🫖☕', so:'Guddoomiyaha Shaaha iyo Kafeega', no:'Styrelederen for shaah og kaffe', summarySo:'Waxaad taqaan goorta shaah la shubo iyo goorta kafeega la qaato. Labada dhinacba waad isu keentaa.', summaryNo:'Du vet når det trengs shaah og når det holder med kaffe. Møtet venter på deg.' },
  ...
  resultIntroSo:'Natiijadu xukun kama bixinayso aqoonsigaaga. Waxay kaliya muujinaysaa jawaabaha aad maanta dooratay — iyo meesha kaftan, su’aal ama wada hadal cusub ka bilaabmi karo.',
  ...
  actions: {
    ...
    bridge:{so:'Hal fikrad laba af ugu sharax qof kaa yar ama kaa weyn, dabadeed weydii waxa ka dhiman.',no:'Forklar én idé på begge språk til noen yngre eller eldre, og spør hva som manglet.'}
  }
};
