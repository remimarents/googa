...
<head>
  ...
  <section class="gift-head"><button class="lang" id="lang" type="button">🇳🇴</button><img src="<?= htmlspecialchars(googa_asset_url('assets/googa-mascot.png'), ENT_QUOTES, 'UTF-8') ?>" alt=""><p><b>GOOGA HADIYAD</b></p><h1 data-so="Hadiyad sii qoys" data-no="Gi Googa til en familie">Hadiyad sii qoys</h1><p data-so="Hal mar bixi. Qoyska aad doorato wuxuu helayaa Googa muddada oo dhan. Lacagtu si toos ah uma cusboonaanayso." data-no="Betal én gang. Mottakeren får Googa i hele perioden, uten automatisk fornyelse.">Hal mar bixi. Qoyska aad doorato wuxuu helayaa Googa muddada oo dhan. Lacagtu si toos ah uma cusboonaanayso.</p></section>
  <?php if ($paymentState === 'cancelled'): ?><p class="message">Lacag-bixinta waa la joojiyey. Wax lacag ah lama qaadin.</p><?php endif; ?>
  <?php if ($paymentState === 'success'): ?><p class="message" style="background:#dff5e5">Hadiyadda waa la diray! Qofka qaadanaya wuxuu helayaa e-mail uu ku samaysto furaha Googa.</p><?php endif; ?>
