...
<main class="landing">
  ...
  <div class="free-test free-culture-front"><a href="culture-test.php"><span><b data-so="Bariis på Grandis" data-no="Bariis på Grandis">Bariis på Grandis</b><small data-so="Tijaabo dhaqan oo bilaash ah · akoon looma baahna" data-no="Gratis kulturkompass · ingen innlogging">Tijaabo dhaqan oo bilaash ah · akoon looma baahna</small></span><strong aria-hidden="true">→</strong></a><a class="arab-contact-link" href="contact.php" data-so="💬 Farriin u dir Arab →" data-no="💬 Send melding til Arab →">💬 Farriin u dir Arab →</a></div>
  ...
  <div class="plans single-offer">
    <form method="post" action="checkout.php"><input type="hidden" name="csrf" value="<?= htmlspecialchars((string)$_SESSION['googa_payment_csrf'], ENT_QUOTES, 'UTF-8') ?>"><input type="hidden" name="kind" value="trial"><button class="plan offer" type="submit"><span class="offer-kicker" data-so="2 maalmood oo tijaabo ah" data-no="2 dagers prøveperiode">2 maalmood oo tijaabo ah</span><span class="offer-title" data-so="Googa maanta bilow" data-no="Start Googa i dag">Googa maanta bilow</span><b>kr 5</b><small class="offer-renewal" data-so="Kadib kr 50 bishii. Xubinimadu si toos ah ayay u soconaysaa ilaa aad joojiso." data-no="Deretter kr 50 per måned. Abonnementet fornyes automatisk til du sier opp.">Kadib kr 50 bishii. Xubinimadu si toos ah ayay u soconaysaa ilaa aad joojiso.</small><em data-so="Ku bilow kr 5 →" data-no="Start for kr 5 →">Ku bilow kr 5 →</em><span class="offer-cancel" data-so="✓ Jooji wakhti kasta" data-no="✓ Si opp når som helst">✓ Jooji wakhti kasta</span></button><button class="read-aloud" type="button" data-speak-button data-speak-so="Googa maanta ku bilow shan karoon. Waxaad helaysaa laba maalmood oo tijaabo ah. Kadib xubinimadu waa konton karoon bishii ilaa aad joojiso." data-speak-audio="audio/ui/plan-trial.mp3" aria-label="Dhegeyso qiimaha">🔊</button></form>
  </div>
  ...
  <p class="purchase-note" data-so="Hal taabasho ayaa ku geynaysa lacag-bixinta ammaan ah ee Stripe." data-no="Ett trykk tar deg til sikker betaling hos Stripe." data-speak-so="Hal taabasho ayaa ku geynaysa lacag-bixinta ammaan ah ee Stripe.">Hal taabasho ayaa ku geynaysa lacag-bixinta ammaan ah ee Stripe.</p>
  <div class="divider" data-so="Hore akoon ma u leedahay?" data-no="Har du allerede en konto?" data-speak-so="Hore akoon ma u leedahay? Geli e-mailkaaga iyo furaha sirta ah." data-speak-audio="audio/ui/login-account.mp3">Hore akoon ma u leedahay?</div>
  <form method="post" class="login-grid">
    ...
    <div class="fields"><div class="field"><label for="email" data-so="E-mail" data-no="E-post">E-mail</label><input id="email" name="email" type="email" autocomplete="username" required></div><div class="field"><label for="password" data-so="Furaha sirta ah" data-no="Passord">Furaha sirta ah</label><input id="password" name="password" type="password" autocomplete="current-password" required></div></div>
    <button class="primary" type="submit" data-so="Soo gal" data-no="Logg inn">Soo gal</button>
  </form>
  <div class="benefits"><span><b>3</b><i data-so="qalab carruureed" data-no="barneenheter">qalab carruureed</i></span><span><b>✦</b><i data-so="wax cusub bil kasta" data-no="nytt hver måned">wax cusub bil kasta</i></span><span><b>♪</b><i data-so="cod Af-Soomaali" data-no="somalisk lyd">cod Af-Soomaali</i></span></div>
  ...
  <p class="terms" data-so="Waxaad bixinaysaa kr 5 hadda. Laba maalmood kadib xubinimadu si toos ah ayay ugu soconaysaa kr 50 bishii ilaa aad joojiso. Stripe ayaa si ammaan ah u maamusha lacag-bixinta. Marka waalidku galo, carruurtu waxay ku xirmayaan QR-koodhka qoyska." data-no="Du betaler kr 5 nå. Etter to dager fortsetter abonnementet automatisk til kr 50 per måned frem til oppsigelse. Stripe håndterer betalingen sikkert. Barn kobles til med familie-QR etter at forelderen har logget inn." data-speak-so="Waxaad bixinaysaa shan karoon hadda. Laba maalmood kadib xubinimadu si toos ah ayay ugu soconaysaa konton karoon bishii ilaa aad joojiso. Stripe ayaa si ammaan ah u maamusha lacag-bixinta.">Waxaad bixinaysaa kr 5 hadda. Laba maalmood kadib xubinimadu si toos ah ayay ugu soconaysaa kr 50 bishii ilaa aad joojiso. Stripe ayaa si ammaan ah u maamusha lacag-bixinta.</p>
</main>
