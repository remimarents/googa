...
const state = { level: Math.min(saved.level || 0, Math.max(0, playableLevelCount - 1)), found: saved.found || {}, letters: [], bonus: [], norwegian: false };
