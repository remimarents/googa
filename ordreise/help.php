...
</style><style>.game-shot{margin:18px 0;border:1px solid #b9d8f5;border-radius:20px;overflow:hidden;background:#eaf6ff;box-shadow:0 14px 28px #1767ad20}.game-shot img{display:block;width:100%;height:auto}.game-shot figcaption{padding:10px 13px;color:#315c7b;font-size:13px;font-weight:800}</style>
...
<figure class="game-shot"><img src="assets/ordreise-wheel-preview.png?v=<?= rawurlencode(googa_app_version()) ?>" alt="Ordreise med bokstaver i hjul og synlig sveipespor"><figcaption>Bokstavhjulet bruker også somaliske digrafer som DH, KH og SH når de forekommer.</figcaption></figure>
