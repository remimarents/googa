...
const clips = {
  ...
  'login-account': 'Hore akoon ma u leedahay? Geli e-mailkaaga iyo furaha sirta ah.',
  ...
  'plan-monthly': 'Xubinimada Googa. Konton karoon bishii.',
  ...
  'payment-processing': 'Lacag-bixinta waa la xaqiijinayaa. Wax yar kadib dib u hubi gelitaanka.',
  'portal-error': 'Maareynta xubinimada lama furi karo hadda.',
  'access-title': 'Akoonkaaga waa la aqoonsaday.',
  'access-intro': 'Waad soo gashay, laakiin akoonkan weli ma laha gelitaan shaqaynaya oo Googa ah. Ku bilow shan karoon si aad u hesho laba maalmood oo tijaabo ah.',
  'access-offer': 'Tijaabadu waxay hadda ku kacaysaa shan karoon. Kadib xubinimadu waa konton karoon bishii ilaa aad joojiso. Marka lacag-bixinta la xaqiijiyo, waxaad si toos ah u geli doontaa Googa.',
  'family-title': 'La wadaag carruurtaada.',
  'family-qr': 'QR-koodhkani waa joogto. Kaamirada taleefanka ilmaha ku akhri. Marka qalab cusub codsado gelitaan, adiga ayaa oggolaanaya. Qalabka afraad wuxuu beddelayaa qalabkii ugu horreeyey.',
  'family-save': 'Googa ku dar shaashadda guriga si uu ugu shaqeeyo sida app. iPhone ama iPad: Safari ka fur. Taabo La wadaag. Dooro Ku dar Shaashadda Guriga, dabadeed taabo Ku dar. Android: Chrome ka fur. Taabo liiska saddexda dhibcood. Dooro Ku rakib app-ka ama Ku dar shaashadda guriga.',
  ...
  'welcome': 'Ciyaar. Baadhitaan. Af-Soomaali. Maskaxda yar, sir weyn! Dooro da’daada. Googa wuxuu kuu hayaa halxiraale maanta.',
